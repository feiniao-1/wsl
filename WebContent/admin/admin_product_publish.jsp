...
<ul class="bread">
  ...
  <li><a href="##" id="a_leader_txt">产品编辑页</a></li>
  ...
  <!-- 图片上传start  -->
     <div class="form-group">
        		<h5 class="mb10">PC封面图<span style="color:red;">*(240*180)</span></h5> 
					<form action="${pageContext.request.contextPath }/uploadServlet?url=productpublish&caiid=<%= caiid%>&shuzi=1&page=<%=request.getParameter("page") %>&paixu=<%=request.getParameter("paixu") %>&searchnr=<%= param.get("searchnr")%>" method="post" enctype="multipart/form-data">
						<div class="mb10">
				  	 ...
				  	 <br>
						...
						<form action="${pageContext.request.contextPath }/uploadServlet?url=productpublish&caiid=<%= caiid%>&shuzi=2&page=<%=request.getParameter("page") %>&paixu=<%=request.getParameter("paixu") %>&searchnr=<%= param.get("searchnr")%>" method="post" enctype="multipart/form-data">
						<div class="mb10">
						<input type="file" id="url1" name="img" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
						<input type="submit" value="浏览上传" class="button bg-blue margin-left" style="float:left;" > 	
					...
					<form action="${pageContext.request.contextPath }/uploadServlet?url=productpublish&caiid=<%= caiid%>&shuzi=3&page=<%=request.getParameter("page") %>&paixu=<%=request.getParameter("paixu") %>&searchnr=<%= param.get("searchnr")%>" method="post" enctype="multipart/form-data">
						<div class="mb10">
						<input type="file" id="url1" name="img" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
						<input type="submit" value="浏览上传" class="button bg-blue margin-left" style="float:left;" > 
					...
					<form action="${pageContext.request.contextPath }/uploadServlet?url=productpublish&caiid=<%= caiid%>&shuzi=4&page=<%=request.getParameter("page") %>&paixu=<%=request.getParameter("paixu") %>&searchnr=<%= param.get("searchnr")%>" method="post" enctype="multipart/form-data">
						<div class="mb10">
						<input type="file" id="url1" name="img" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
						<input type="submit" value="浏览上传" class="button bg-blue margin-left" style="float:left;" >   
